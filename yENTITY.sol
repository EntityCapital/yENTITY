...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant reserveSupply = 2000e18;
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developer and affiliated parties of ENTITY are not responsible of the way you handle your funds, and that any smart contract interaction carries an inherent risk. This project is experimental, DYOR.";
        ...
        returns (uint256)
    {
        ...
        console.log("8 days since start is", contractStartTimestamp.add(8 days), "Time now is", block.timestamp);
    ...
    function addLiquidityToUniswapYENTITYxWETHPair() public {
        require(liquidityGenerationOngoing() == false, "yEntity LGE ongoing");
        require(LPGenerationCompleted == false, "yEntity LGE is already finished");
    ...
    // Emergency drain in case of bug within the LGE
    // Adds all funds to owner to refund people
    // Can be invoked only from 24 hours after LGE ends
    // Designed to be as simple as possible
    function emergencyDrain24hAfterLiquidityGenerationEventIsDone() public onlyOwner {
        require(contractStartTimestamp.add(9 days) < block.timestamp, "Liquidity generation grace period still ongoing"); // About 24h after liquidity generation happens
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IYentityVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
contract YENTITY is NBUNIERC20, SafeGuard {
    /**
